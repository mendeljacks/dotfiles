...
case "$TERM" in
xterm-color | *-256color | xterm-ghostty | alacritty) color_prompt=yes ;;
esac
...
if [ -f '/home/pc/google-cloud-sdk/path.bash.inc' ]; then . '/home/pc/google-cloud-sdk/path.bash.inc'; fi
...
# Daily notes shortcut - opens today's note in nvim
dn() {
  local note_path="$HOME/gdrive/rclone/Documents/obsidian/daily notes/$(date +%Y-%m-%d).md"
  nvim "$note_path"
}
o() {
  cd ~/gdrive/rclone/Documents/obsidian && nvim .
}
k() {
